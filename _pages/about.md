...
- *SET: Stream-Event-Triggered Scheduling for Efficient CUDA Graph Pipelines*  
  **Zhengxiong Li**, Tsung-Wei Huang, Umit Ogras  
  Euro-Par, Pisa, Italy, 2026  
  [DOI](https://doi.org/10.1007/978-3-032-35251-4_17){: .btn .pub-btn }
  [PDF](/files/set-paper.pdf){: .btn .pub-btn }
  [Slides](/files/set-slides.pdf){: .btn .pub-btn }
  [Poster](/files/set-poster.pdf){: .btn .pub-btn }
  [Code](https://github.com/username/project){: .btn .pub-btn }
